...
%>
	...
	<td class="l_text" bgcolor="#FFFFFF"><div align="center"><a class="l_text" href="<%=sObject%>_delete.asp?ID=<%=oRs(0)%>&Copy=1" onclick="return confirm('¿Está seguro que desea eliminar la copia?')">elim. copia</a></div></td>
