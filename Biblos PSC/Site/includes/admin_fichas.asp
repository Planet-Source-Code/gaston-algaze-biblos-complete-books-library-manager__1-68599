...
<%		
			...
			While Not (oRs.Eof OR oRs.Absolutepage <> ipageCurrent)
				For i = 1 To iFieldsLimit - (1 + iShowDeleted)
%>
	<td class="m1_text"><div align="center"><a class="m2_text" onClick="myRef = window.open('fichas_download.asp?ID=<%=oRs(0)%>','mywin',
'left=0,top=0,width=1,height=1,scrollbars=0,toolbar=0,resizable=0');
myRef.focus()" onmouseover="return escape('Haga click aqui para descargar el archivo.')" href="javascript:void(0);"><%=oRs(i)%></a></div></td>
<%	
				Next
%>
